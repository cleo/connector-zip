...
public class TestZipFilenameEncoder {
    ...
    public void testFilenames() {
        ...
        assertArrayEquals(new int[] {0, 1, 13, 0}, ZipFilenameEncoder.parseFilename(encoder.getFilename(1)).checkpoint());
    }
    ...
    public void testDecoder() {
        Partition p;
        p = ZipFilenameEncoder.parseFilename("part3-0Teyo_4ZgaJu.zip");
        System.out.println(p);
        p = ZipFilenameEncoder.parseFilename("part4-0Teyo_4fgfQl.zip");
        System.out.println(p);
    }
}
